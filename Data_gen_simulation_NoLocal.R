...
library(extraDistr)
library(MASS)
L1.local.true = 6 # true number of tables in population 1
L2.local.true = 7 # true number of tables in population 2
L3.local.true = 5 # true number of tables in population 3

L.global.true = 8 # true number of dishes in population
alpha0 = 25
m0 = 25
